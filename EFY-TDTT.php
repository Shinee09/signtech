...
$sCVU = $_POST["CVU"];
$sTTP = $_POST["ttp"];
$sCTYC = $_POST["ctyc-efytdtt"];

$sCTYM = $_POST["ctym-efytdtt"];
$sDCM = $_POST["dcm-efytdtt"];
...
$template_file_name = 'EFY-inputTDTT.docx';
...
try
{
    ...
    if($zip->open($full_path) == true)
    {
        ...
        $message = str_replace("tokenmcty", $sCTYM,   $message);
        $message = str_replace("tokenmdc", $sDCM,   $message);
