...
$sSERIALCTS = $_POST["serial-cts-efythuhoi"];
$sSERIALTOKEN = $_POST["serial-token-efythuhoi"];
$sLYDO = $_POST["lydo-efythuhoi"];
...
$template_file_name = 'EFY-inputTH.docx';
$fileName = "THU_HOI_" . $sMST. ".docx";
$folder   = "EFY-CA";
...
try
{
    ...
    if($zip->open($full_path) == true)
    {
        ...
        $message = str_replace("serialCTS", $sSERIALCTS,   $message);
        $message = str_replace("serialToken", $sSERIALTOKEN,   $message);
        $message = str_replace("tokenlydo", $sLYDO,   $message);
