...
$sCTYTTC = $_POST["vina-cty-ttc"];
$sCTYTTM = $_POST["vina-cty-ttm"];

$sDCTTC = $_POST["vina-dc-ttc"];
$sDCTTM = $_POST["vina-dc-ttm"];
...
try
{
    ...
    if($zip->open($full_path) == true)
    {
        ...
        $message = str_replace("tokenttccty",   $sCTYTTC, $message);
        $message = str_replace("tokenttmcty",   $sCTYTTM, $message);

        $message = str_replace("tokenttcdc",   $sDCTTC, $message);
        $message = str_replace("tokenttmdc",   $sDCTTM, $message);
